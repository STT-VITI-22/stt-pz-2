...
describe('Test suite for testing lib.js', () => {
  ...
  describe('getVowels function', () => {
    it('should return array of vowels from string', () => {
      const str = 'Hello World';
      const result = getVowels(str);
      const expected = ['e', 'o', 'o']; // Очікувані голосні зі строки 'Hello World'
  
    });
  
    it('should return empty array if string has no vowels', () => {
      const str = '123456';
      const result = getVowels(str);
      const expected = []; // Немає голосних у строкі '123456'
    ...
    it('should return empty array if string is empty', () => {
      const str = '';
      const result = getVowels(str);
      const expected = []; // Немає голосних у порожній строкі
  
    });
  
    it('should return empty array if string contains only consonants', () => {
      const str = 'Hello';
      const result = getVowels(str);
      const expected = []; // Немає голосних у строкі 'Hello'
  
    });
  
    it('should return array of vowels if string contains only vowels', () => {
      const str = 'aeiou';
      const result = getVowels(str);
      const expected = ['a', 'e', 'i', 'o', 'u']; // Всі голосні у строкі 'aeiou'
